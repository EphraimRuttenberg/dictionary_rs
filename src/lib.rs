...
mod tests{
    ...
    #[test]
    fn create_sized() {
        let _d: Dictionary<u8, u8> = Dictionary::new_sized(16); 
    ...
    #[should_panic]
    fn zero_sized_dict() {
        let _d: Dictionary<u8, u8> = Dictionary::new_sized(0);
    }
    ...
    #[test]
    fn lookup() {
        let _d: Dictionary<u8, u8> = create_dict();
    ...
    #[test]
    fn resize() {
        let mut _d: Dictionary<u8, u8> = Dictionary::new_sized(4);
    ...
    #[test]
    fn contains() {
        let mut _d: Dictionary<u8, u8> = create_dict();
